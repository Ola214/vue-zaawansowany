    ...
    <b-row class="my-1" v-if="isEditing">
      <b-col sm="12" class="editable--padding-bottom">
        ...
        <b-form-input
          ...
          type="text"
          v-model="names"
          placeholder="Podaj imie i nazwisko gracza"
        />
      </b-col>
    </b-row>
    <b-button
...
export default {
  ...
  methods: {
    remove() {
      if (
        confirm(
          `Czy na pewno chcesz usunąć gracza ${this.name} ${this.lastName}?`
        )
      ) {
