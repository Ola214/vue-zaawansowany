    ...
    <b-container>
      <b-col sm="12">
        ...
        <b-form @submit="onSubmit" @reset="onReset">
          <b-form-group label="Nazwa lokacji:" label-for="loc_name">
            <b-form-input
              id="loc_name"
              type="text"
            ...
            <b-form-invalid-feedback>
              ...
              <p v-if="!$v.locName.minLength">
                Nazwa lokacji musi mieć długość conajmniej 5 znaków
              </p>
            </b-form-invalid-feedback>
            <b-form-valid-feedback> Wszystko jest okej! </b-form-valid-feedback>
          </b-form-group>

          <b-form-group label="Minimalny poziom:" label-for="loc_minlevel">
            <b-form-input
              id="loc_minlevel"
              type="number"
            ...
            <b-form-invalid-feedback>
              ...
              <p v-if="!$v.locMinLvl.minLevel">
                Minimalny poziom dodawanej lokacji to 15
              </p>
            </b-form-invalid-feedback>
            <b-form-valid-feedback> Wszystko jest okej! </b-form-valid-feedback>
          </b-form-group>

          <b-form-group label="Czy ma opis:" label-for="loc_hasDesc">
            <b-form-checkbox switch id="loc_hasDesc" v-model="hasDescription" />
          </b-form-group>
          ...
          >
            ...
            <b-form-invalid-feedback>
              ...
              <p v-if="!$v.locDesc.minLength">
                Opis musi mieć długość conajmniej 10 znaków
              </p>
            </b-form-invalid-feedback>
            <b-form-valid-feedback> Wszystko jest okej! </b-form-valid-feedback>
          </b-form-group>
...
const properDescription =
  (value, vm) => value.toLowerCase().indexOf(vm.locName) > -1;
